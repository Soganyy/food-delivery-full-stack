  ...
  return (
    <div>
      <TitleBackground
        ...
        p={
          "People are ordering a lot now, which is why you can only order from nearby venues (for now). It might also take longer to deliver, and support could be slower to respond. Please know that we’re pushing hard to get back up to speed fast – thanks for understanding! 💙"
        }
        height={500}
        isDarkOverlay={false}
        textColor={"black"}
      ...
      <div className="container mt-5">
        ...
        <TitleBackground className="mt-5  mb-5 " img={joinUsImg} height={200} />

        <MenuComponent height={200} className="mt-5 mb-5" query="" />
        <MenuComponent height={400} className="mt-5 mb-5" query="burger" />
        <iframe
          style={{ borderRadius: "12px" }}
          title="spotifyTrackShusa"
          src="https://open.spotify.com/embed/track/5mIz80bVNH4WLjsSOdUhKj?utm_source=generator"
          width="100%"
          height="352"
          allowfullscreen=""
